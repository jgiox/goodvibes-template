...
This file is the authoritative rule file for GitHub Copilot in this repository; Copilot reads it ahead of `AGENTS.md`, which is only the cross-tool fallback. Every rule below is an order, not a suggestion.
